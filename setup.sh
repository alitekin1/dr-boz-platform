...
banner() {
    echo -e "${CYAN}${BOLD}"
    echo "╔══════════════════════════════════════════════╗"
    echo "║        Dr. Boz Platform — Deployment         ║"
    echo "║        github.com/alitekin1/dr-boz-platform   ║"
    echo "╚══════════════════════════════════════════════╝"
    echo -e "${NC}"
}
...
show_status() {
    ...
    echo -e "${GREEN}${BOLD}║  Dr. Boz Platform — Deployed!                      ║${NC}"
    echo -e "${GREEN}${BOLD}╠══════════════════════════════════════════════════════╣${NC}"
    echo -e "${GREEN}${BOLD}║${NC}                                                     ${GREEN}${BOLD}║${NC}"
    ...
    echo -e "${GREEN}${BOLD}║${NC}  Repo:    github.com/alitekin1/dr-boz-platform       ${GREEN}${BOLD}║${NC}"
    echo -e "${GREEN}${BOLD}║${NC}                                                     ${GREEN}${BOLD}║${NC}"
