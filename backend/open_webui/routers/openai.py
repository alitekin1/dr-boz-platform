...
async def generate_chat_completion(
    ...
    if api_config.get('azure', False):
        ...
        if is_responses:
            ...
            # Ask OpenAI-compatible providers to include token usage in the
            # final streaming chunk. Without this, many proxies / older
            # OpenAI-compatible APIs silently drop usage from the stream
            # (we only get it in non-streaming mode), which breaks
