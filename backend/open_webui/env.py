...
WEBUI_NAME = os.environ.get('WEBUI_NAME', 'Dr. Boz')

WEBUI_FAVICON_URL = 'https://drboz.com/favicon.png'
...
FORWARD_USER_INFO_HEADER_USER_NAME = os.environ.get('FORWARD_USER_INFO_HEADER_USER_NAME', 'X-DRBoz-User-Name')
FORWARD_USER_INFO_HEADER_USER_ID = os.environ.get('FORWARD_USER_INFO_HEADER_USER_ID', 'X-DRBoz-User-Id')
FORWARD_USER_INFO_HEADER_USER_EMAIL = os.environ.get('FORWARD_USER_INFO_HEADER_USER_EMAIL', 'X-DRBoz-User-Email')
FORWARD_USER_INFO_HEADER_USER_ROLE = os.environ.get('FORWARD_USER_INFO_HEADER_USER_ROLE', 'X-DRBoz-User-Role')
...
FORWARD_SESSION_INFO_HEADER_MESSAGE_ID = os.environ.get(
    'FORWARD_SESSION_INFO_HEADER_MESSAGE_ID', 'X-DRBoz-Message-Id'
)
FORWARD_SESSION_INFO_HEADER_CHAT_ID = os.environ.get('FORWARD_SESSION_INFO_HEADER_CHAT_ID', 'X-DRBoz-Chat-Id')
...
REDIS_KEY_PREFIX = os.environ.get('REDIS_KEY_PREFIX', 'dr-boz')
...
####################################
# Bot Authentication (Telegram / Bale)
####################################

# Telegram Bot Token (for Mini App initData verification & deep linking)
TELEGRAM_BOT_TOKEN = os.environ.get('TELEGRAM_BOT_TOKEN', '')

# Telegram Bot Username (for generating bot links in frontend)
TELEGRAM_BOT_USERNAME = os.environ.get('TELEGRAM_BOT_USERNAME', '@DrBozBot')

# Bale Bot Token
BALE_BOT_TOKEN = os.environ.get('BALE_BOT_TOKEN', '')

# Bale Bot Username
BALE_BOT_USERNAME = os.environ.get('BALE_BOT_USERNAME', '@DrBozBale')

# Auth code TTL in seconds (default 5 minutes)
AUTH_CODE_TTL = int(os.environ.get('AUTH_CODE_TTL', '300'))

# Master switch: disable public signup
# When True, /signup is only allowed for first admin creation
ENABLE_SIGNUP_AFTER_ADMIN = os.environ.get(
    'ENABLE_SIGNUP',
    str(os.environ.get('WEBUI_AUTH', 'True').lower() == 'false')
).lower() == 'true'
...
OTEL_SERVICE_NAME = os.environ.get('OTEL_SERVICE_NAME', 'dr-boz')
